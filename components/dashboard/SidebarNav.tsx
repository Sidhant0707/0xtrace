...
export function SidebarNav({ anomalyCount, projects, activeProject }: SidebarNavProps) {
  ...
  const secondaryNav: NavItem[] = [
    ...
    { label: "Docs",     href: "https://docs.0xtrace.dev", matchPrefix: "__never__",       icon: Icons.Docs },
  ];
